...
function setup() {
  ...
  // COVER oznacza wypełnienie całego prostokąta, w którym będzie umieszczony obrazek
  // Dzięki temu obrazek nie będzie zniekształcony, a jedynie przycięty (skadrowany)
  image(img, cx, cy, cw, ch, ix, iy, iw, ih, COVER);
}